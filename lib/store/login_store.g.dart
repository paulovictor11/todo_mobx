...
mixin _$LoginStore on _LoginStore, Store {
  ...
  String toString() {
    final string =
        'email: ${email.toString()},password: ${password.toString()},visible: ${visible.toString()},loading: ${loading.toString()},loggedIn: ${loggedIn.toString()},isEmailValid: ${isEmailValid.toString()},isPasswordValid: ${isPasswordValid.toString()},loginPressed: ${loginPressed.toString()}';
    return '{$string}';
  }
}
